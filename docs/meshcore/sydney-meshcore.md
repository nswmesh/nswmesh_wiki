...
Send an advert by hitting the 'advert' → 'Send Flood Advert' to send your node name to the mesh. Direcr reachable repeaters can be discovered by 'Advert' → 'Discover Nearby Nodes' → 'Discover Repeaters'. After a short while repeaters within range should reply with their info. you can hit the '+' to add them into your contacts.
